...
export const en = {
  ...
  tokenCurrent: 'Current: {name}',
  tokenNone: 'No saved tokens',
  tokenUnselected: 'Not selected',
  tokenAdd: 'Add token',
  tokenName: 'Token name',
  tokenNamePlaceholder: 'e.g. Work account',
  tokenNameRequired: 'Enter a name for this token.',
  tokenKey: 'Token key',
  tokenKeyRequired: 'Enter the key of this token.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  tokenSwitch: '切换 Token',
  tokenCurrent: '当前：{name}',
  tokenNone: '没有已保存的 Token',
  tokenUnselected: '未选择',
  tokenAdd: '添加 Token',
  tokenName: 'Token 名称',
  tokenNamePlaceholder: '例如：工作号',
  tokenNameRequired: '请输入 Token 名称。',
  tokenKey: 'Token 密钥',
  tokenKeyRequired: '请输入 Token 密钥。',
  tokenSave: '保存 Token',
