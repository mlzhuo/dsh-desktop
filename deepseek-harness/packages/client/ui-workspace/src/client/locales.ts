...
export const zh = {
  ...
  'unarchive.workspace': '取消归档',
  'archive.workspace.badge': '已归档',
  'archive.section': '已归档 ({n})',
  'delete.session': '删除会话',
  'delete.session.desc': '将永久删除会话“{name}”及其全部记录，此操作不可恢复。',
...
export const en = {
  ...
  'archive.workspace.badge': 'Archived',
  'archive.section': 'Archived ({n})',
  'delete.session': 'Delete session',
  'delete.session.desc': 'This permanently deletes session “{name}” and its full record. This action cannot be undone.',
