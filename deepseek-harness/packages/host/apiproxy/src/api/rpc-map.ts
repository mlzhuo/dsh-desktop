...
export interface RpcMethodMap {
  ...
  'workspace.archiveWorkspace': WorkspaceApi['archiveWorkspace']
  'workspace.unarchiveWorkspace': WorkspaceApi['unarchiveWorkspace']
  ...
  'stats.daily': StatsApi['daily']
  'stats.balance': StatsApi['balance']
}
