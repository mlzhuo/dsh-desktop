...
/** workspace.archiveWorkspace request payload. */
export const workspaceArchiveWorkspaceRequestSchema = z.object({
  workspaceId: workspaceIdSchema,
}) satisfies z.ZodType<Wire<RequestPayload<'workspace.archiveWorkspace'>>>

/** workspace.archiveWorkspace response value: the updated workspace row. */
export const workspaceArchiveWorkspaceValueSchema = z.object({
  workspace: workspaceViewSchema,
}) satisfies z.ZodType<Wire<ResponseValue<'workspace.archiveWorkspace'>>>

/** workspace.unarchiveWorkspace request payload. */
export const workspaceUnarchiveWorkspaceRequestSchema = z.object({
  workspaceId: workspaceIdSchema,
}) satisfies z.ZodType<Wire<RequestPayload<'workspace.unarchiveWorkspace'>>>

/** workspace.unarchiveWorkspace response value: the updated workspace row. */
export const workspaceUnarchiveWorkspaceValueSchema = z.object({
  workspace: workspaceViewSchema,
}) satisfies z.ZodType<Wire<ResponseValue<'workspace.unarchiveWorkspace'>>>
