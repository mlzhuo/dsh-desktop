...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'workspace.archiveWorkspace': { schema: workspaceArchiveWorkspaceRequestSchema, invoke: (api, r) => api.workspace.archiveWorkspace(r) },
  'workspace.unarchiveWorkspace': { schema: workspaceUnarchiveWorkspaceRequestSchema, invoke: (api, r) => api.workspace.unarchiveWorkspace(r) },
  ...
  'stats.daily': { schema: statsDailyRequestSchema, invoke: (api, r, signal) => api.stats.daily(r, signal) },
  'stats.balance': { schema: statsBalanceRequestSchema, invoke: (api, r, signal) => api.stats.balance(r, signal) },
}
